...
ALLOWED_HOSTS = [h for h in os.getenv('DJANGO_ALLOWED_HOSTS', 'localhost,127.0.0.1,0.0.0.0').split(',') if h]
...
if _trusted:
    CSRF_TRUSTED_ORIGINS = [o for o in _trusted.split(',') if o]
...
LOGGING = {
    ...
    'loggers': {
        ...
        'storage': {
            'handlers': ['console'],
            'level': os.getenv('STORAGE_LOG_LEVEL', 'INFO'),
            'propagate': False,
        },
    },
}

# Celery configuration defaults to the Redis service provided in docker-compose.
